...
def loginSC():
	...
	if username =="MR.DM" and password =="ProDrifter":
...
def masuk():
	...
	if msuk =="":
		...
		os.system('xdg-open https://www.facebook.com/optimus.vans44')
